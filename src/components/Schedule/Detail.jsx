  ...
  render() {
    ...
    return (
      <div className={`pure-u-1 pure-u-md-1-2 ${this.props.css} close`} onClick={this.handleClick}>
        ...
        <a className="download" style={{display: this.props.data.slide_url ? 'inline' : 'none'}} href={this.props.data.slide_url}>投影片 <i className="fa fa-slideshare"></i>&nbsp;</a>
        <a className="download" style={{display: this.props.data.youtube_url ? 'inline' : 'none'}} href={this.props.data.youtube_url} target="_blank">Youtube <i className="fa fa-youtube-play"></i>&nbsp;</a>
